...
It seems from Figures \ref{fig:vert_ALT}-\ref{fig:vert_ZEP} that \chem{HBr} is the main halogen species controlling the ozone content. According to \cite{CAO}, \chem{HBr} will be the dominating species left after a BE.
