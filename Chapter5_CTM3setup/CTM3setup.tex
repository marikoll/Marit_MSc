...
This chapter describes the setup and altered modules of the Oslo CTM3. The altered modules that are connected to the theory outlined in Chapter \ref{Chap:CTM3theory_ocean_hetReact} is presented here, whereas many of the technical aspects of setting up the Oslo CTM3 can be found in the appendix. 
