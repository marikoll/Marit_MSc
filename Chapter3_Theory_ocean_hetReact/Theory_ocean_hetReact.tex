...
Reactions \ref{R:clono2} and \ref{R:13} were implemented by using the 3 body reaction scheme for their reaction rate constants. \cite{SovdeManual}. A three-body reaction is the reaction of two species, \chem{A} and \chem{B}, involving a third body, \chem{M}, to form a new species, \chem{AB}. The third body is an inert molecule (generally $\chem{N_2}$ or $\chem{O_2}$ in the atmosphere) that removes excess energy from the excited species $\chem{AB*}$ leaving the product species \chem{AB} in it's unexcited state (\cite{Jacob1999}).