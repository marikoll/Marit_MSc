...
Figure \ref{fig:joint_FebApr} and \ref{fig:joint_AprMay} contains distributions of the agreements between the original CTM3, the BE-branch and the observational data. They are divided into two periods to separate the BE-branch results before stabilization and after, respectively (before the 24th of April and after). 

\medskip

In Figures \ref{fig:BE_origPD_vmr_FebMarch} - \ref{fig:BE_origPD_vmr_AprJun}, the monthly mean mixing ratio (in ppb) from the first model layer of the BE-branch is subtracted from the first model layer of the CTM3-branch and the difference is shown globally and for the Arctic (above 68$^o$N) for the months February through June in 2001. In February (Figure \ref{fig:BE_origPD_vmr_FebMarch}), the BE-branch produces a higher 

\input{Chapter6_Results/images/jointplot_FebApr_O3_2001}
\input{Chapter6_Results/images/jointplot_AprJune_O3_2001}


\input{Chapter6_Results/images/BE_origPD_vmr_FebMarch}
\input{Chapter6_Results/images/BE_origPD_vmr_AprJun}
