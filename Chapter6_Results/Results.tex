...
\subsection{Lmix = 100, \chem{HBr} Adjusted to 30 ppt}
...
\subsection{Lmix = 200, \chem{HBr} Adjusted to 10 ppt}
...
\subsection{Lmix = 100, with new restart file}
...
\subsection{Lmix = 50, with new restart file}
...
\subsection{Lmix = 25, with new restart file}
...
\subsection{Lmix = 100, cycling of \chem{HOBr} and \chem{HBr} and hard-coded photodissociation rates}
...
\subsection{Lmix = 100, new Henry's law constants for \chem{HBr} and \chem{HCl}}
