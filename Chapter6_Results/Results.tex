...
Figure \ref{fig:joint_FebApr} and \ref{fig:joint_AprMay} contains scatterplots to visualise agreements between the original CTM3, the BE-branch and the observational data. They are divided into two periods to separate the BE-branch results before stabilization and after, respectively. 
