...
In order to boost the concentration of \chem{HBr}, the concentration was set to 30 ppt ($= 8.059 \text{molecules}cm^{-3}$ at $273.15 K$) in the first sub-timestep of \texttt{pchemc\_ij.f90}.  
