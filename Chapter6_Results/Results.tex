...
In Figures \ref{fig:BE_origPD_vmr_FebMarch} - \ref{fig:BE_origPD_vmr_AprJun}, the monthly mean mixing ratio (in ppb) from the first model layer of the BE-branch is subtracted from the first model layer of the CTM3-branch and the difference is shown globally and for the Arctic (above 68$^o$N) for the months February through June in 2001. 
